...
class PosterSection extends StatelessWidget {
  ...
  // 🛠️ Helper function to apply the localhost fix
  String _getFixedImageUrl(String imageUrl) {
    ...
    if (imageUrl.contains('localhost')) {
      // Use replaceFirst for a clean replacement of the host.
        ...
        builder: (context, dataProvider, child) {
          return ListView.builder(
            ...
            itemBuilder: (_, index) {
              ...
              final originalImageUrl = dataProvider.posters[index].imageUrl ?? '';
